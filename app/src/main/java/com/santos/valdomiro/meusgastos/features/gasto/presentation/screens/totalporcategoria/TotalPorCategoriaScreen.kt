...
@Composable
fun TotalPorCategoriaScreen(
    viewModel: TotalPorCategoriaViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        ...
        when {
            ...
            state.isSuccess -> {
                val listaCategorias =
                    (state as? UiState.Success<List<TotalPorCategoriaItemState>>)?.data
                        ?: emptyList()
                    ...
                    LazyColumn(
                        ...
                        items(
                            ...
                            ItemTotalPorCategoriaComponent(
                                ...
                                quantidadeGastos = listaCategorias.size,
                            )
                        }
                    }
                }
